!function (e, t) {
    ...
    var a, r = e.document, n = r.documentElement, o = r.querySelector('meta[name="viewport"]'),
        l = r.querySelector('meta[name="flexible"]'), s = 0, m = 0, d = t.flexible || (t.flexible = {});
    if (o) {
        ...
        if (p) {
            var u = p.match(/initial\-dpr=([\d\.]+)/), f = p.match(/maximum\-dpr=([\d\.]+)/);
    ...
    if (n.setAttribute("data-dpr", s), !o)if (o = r.createElement("meta"), o.setAttribute("name", "viewport"), e.webPageScalable ? o.setAttribute("content", "initial-scale=" + m + ", user-scalable=yes") : o.setAttribute("content", "initial-scale=" + m + ", maximum-scale=" + m + ", minimum-scale=" + m + ", user-scalable=no"), n.firstElementChild) n.firstElementChild.appendChild(o); else {
